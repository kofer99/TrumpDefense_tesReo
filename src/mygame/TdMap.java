...
public class TdMap {
    ...
    public boolean towerplace(Vector3f mousePosition,Quad rat) {
        ...
        int positiony = (int) (rat.getHeight()/2 * ratioy) - (int) (ratioy * mousePosition.getY());
       // positionx -= max/2;
        //positiony -= max/2;
        ...
        System.out.println("saas:" + positiony+ ":" + mousePosition.toString()+ ":" + rat.getHeight());
            ...
            if(positionx >= 0 && positiony >= 0 && positionx < (getWidth() - max - 10) && positiony < (getHeight() - max - 10)) { return false; }
